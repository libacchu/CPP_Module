...
/*   Updated: 2022/11/12 10:23:57 by libacchu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap( std::string init_name ): ClapTrap(init_name) {
	std::cout << B_PINK "ScavTrap default constructor called" DEFAULT << std::endl;
	this->name = init_name;
	this->hitPoints = 100;
...
ScavTrap::~ScavTrap() {
	std::cout << B_PINK "ScavTrap destructor called" DEFAULT << std::endl;
	return ;
}

void ScavTrap::guardGate( void ) {
	std::cout << B_PINK << this->name << " is now in Gate keeper mode." DEFAULT \
			<< std::endl;
}